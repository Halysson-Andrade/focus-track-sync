...
export const UnzipIllustration = () => (
  <Frame label="Clique com o botão direito no arquivo e escolha 'Extrair'">
    ...
    <g transform="translate(40,60)">
      ...
      <text x="30" y="60" textAnchor="middle" fontSize="10" fill="#78350f" fontWeight="bold">
        ZIP
      </text>
    </g>
    <text x="70" y="155" textAnchor="middle" fontSize="9" fill="#475569">
      monitor-extension.zip
    </text>
    {/* Arrow */}
    ...
    <g transform="translate(175,40)">
      ...
      <text x="12" y="22" fontSize="11" fill="#0f172a">
        Abrir
      </text>
      <line x1="8" x2="152" y1="34" y2="34" stroke="#e2e8f0" />
      <rect x="4" y="40" width="152" height="22" rx="3" fill="#dbeafe" />
      <text x="12" y="55" fontSize="11" fill="#1e3a8a" fontWeight="600">
        Extrair tudo…
      </text>
      <text x="12" y="78" fontSize="11" fill="#0f172a">
        Copiar
      </text>
      <text x="12" y="98" fontSize="11" fill="#0f172a">
        Renomear
      </text>
      <text x="12" y="116" fontSize="11" fill="#0f172a">
        Propriedades
      </text>
    </g>
  </Frame>
...
export const ChromeUrlIllustration = () => (
  <Frame label="Cole na barra de endereço e pressione Enter">
    ...
    <text x="150" y="46" textAnchor="middle" fontSize="10" fill="#475569">
      Nova guia
    </text>
    {/* URL bar */}
    <rect
      ...
      strokeWidth="2"
    />
    <text x="56" y="84" fontSize="12" fill="#1e40af" fontFamily="monospace" fontWeight="600">
      chrome://extensions
    </text>
    {/* Cursor */}
    ...
    {/* Hint */}
    <text x="200" y="140" textAnchor="middle" fontSize="11" fill="#64748b">
...
export const DevModeIllustration = () => (
  <Frame label="Ative o 'Modo do desenvolvedor' e clique em 'Carregar sem compactação'">
    ...
    {/* Header bar */}
    <text x="36" y="48" fontSize="13" fill="#0f172a" fontWeight="700">
      Extensões
    </text>
    {/* Dev mode toggle (right side) */}
    <text x="240" y="48" fontSize="10" fill="#475569">
    ...
    <g transform="translate(36,72)">
      ...
      <text x="60" y="20" textAnchor="middle" fontSize="11" fill="#1e3a8a" fontWeight="600">
        Carregar sem compactação
      </text>
      <rect x="130" y="0" width="90" height="30" rx="4" fill="#f1f5f9" stroke="#cbd5e1" />
      <text x="175" y="20" textAnchor="middle" fontSize="10" fill="#475569">
        Empacotar
      </text>
      <rect x="230" y="0" width="70" height="30" rx="4" fill="#f1f5f9" stroke="#cbd5e1" />
      <text x="265" y="20" textAnchor="middle" fontSize="10" fill="#475569">
        Atualizar
      </text>
    </g>
    ...
    />
    <text x="60" y="160" textAnchor="middle" fontSize="10" fill="#ef4444" fontWeight="600">
      Clique aqui
    </text>
    <defs>
...
export const SelectFolderIllustration = () => (
  <Frame label="Selecione a PASTA descompactada (não o arquivo .zip)">
    ...
    <text x="200" y="37" textAnchor="middle" fontSize="11" fill="#0f172a" fontWeight="600">
    ...
    <g transform="translate(36,58)">
      ...
      <text x="52" y="20" fontSize="11" fill="#1e3a8a" fontWeight="600">
        monitor-extension
      </text>
      <text x="280" y="20" fontSize="9" fill="#64748b">
        Pasta
      </text>
      {/* ZIP - greyed out */}
      <g transform="translate(0,34)" opacity="0.4">
        ...
        <text x="52" y="18" fontSize="11" fill="#94a3b8">
          monitor-extension.zip
        </text>
        <text x="280" y="18" fontSize="9" fill="#94a3b8">
          (não aparece)
        </text>
      </g>
    </g>
    ...
    <g transform="translate(220,148)">
      ...
      <text x="35" y="16" textAnchor="middle" fontSize="10" fill="#475569">
        Cancelar
      </text>
      <rect x="78" y="0" width="70" height="24" rx="4" fill="#3b82f6" />
      <text x="113" y="16" textAnchor="middle" fontSize="10" fill="#fff" fontWeight="600">
        Selecionar
      </text>
    </g>
  </Frame>
